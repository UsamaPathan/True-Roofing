  ...
  return (
    <div className="container my-5 info-section ">
      ...
      <div className="inspection d-flex justify-content-between align-items-md-center ">
        ...
        <div className="d-flex align-items-lg-center gap-2">
          <a href="/True-Roofing/" className="d-flex gap-2"><figure><img src={call} alt="" /></figure></a>
                    <a href="/True-Roofing/" className="d-flex gap-2"><figure><img src={Vector} alt="" /></figure></a>
        </div>
      </div>
      </div>
